...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
   ...
   <script type="text/javascript">
  		...
  		function deleteGoods(id){
  	  		if(confirm("确定要删除吗 ?")){
	  	  		//获取商品 ID
				window.location.href = "/360BUY/shoppingCar/DeleteShoppingCarGoodsAction?index=" + id;
  	  		}
  		}
  	   ...
  	   function deleteAllGoods(){
		  ...
		  if(confirm("确定要全部删除吗 ?")){
			   ...
			   for(i=0;i<items.length;i++){
	  	  	   ...
	  	  	   //将选中的商品索引都传递过去
	  	  	   window.location.href = "/360BUY/shoppingCar/DeleteShoppingCarGoodsAction?" + query;
		  }
  	   }
